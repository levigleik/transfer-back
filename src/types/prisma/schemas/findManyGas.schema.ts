...
export const GasFindManySelectSchema: z.ZodType<Prisma.GasSelect> = z.object({
...
export const GasFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    vehicle: z.boolean().optional(),
    gasSupplies: z.boolean().optional(),
...
export const GasFindManySchema: z.ZodType<Prisma.GasFindManyArgs> = z.object({ select: GasFindManySelectSchema.optional(), include: z.lazy(() => GasIncludeObjectSchema.optional()), orderBy: z.union([GasOrderByWithRelationInputObjectSchema, GasOrderByWithRelationInputObjectSchema.array()]).optional(), where: GasWhereInputObjectSchema.optional(), cursor: GasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GasScalarFieldEnumSchema, GasScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.GasFindManyArgs>;

export const GasFindManyZodSchema = z.object({ select: GasFindManySelectSchema.optional(), include: z.lazy(() => GasIncludeObjectSchema.optional()), orderBy: z.union([GasOrderByWithRelationInputObjectSchema, GasOrderByWithRelationInputObjectSchema.array()]).optional(), where: GasWhereInputObjectSchema.optional(), cursor: GasWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([GasScalarFieldEnumSchema, GasScalarFieldEnumSchema.array()]).optional() }).strict();