...
export const DocumentationFindFirstSelectSchema: z.ZodType<Prisma.DocumentationSelect> = z.object({
...
export const DocumentationFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    expiryAt: z.boolean().optional(),
    antecipateRenewal: z.boolean().optional(),
...
export const DocumentationFindFirstSchema: z.ZodType<Prisma.DocumentationFindFirstArgs> = z.object({ select: DocumentationFindFirstSelectSchema.optional(),  orderBy: z.union([DocumentationOrderByWithRelationInputObjectSchema, DocumentationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DocumentationWhereInputObjectSchema.optional(), cursor: DocumentationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DocumentationScalarFieldEnumSchema, DocumentationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DocumentationFindFirstArgs>;

export const DocumentationFindFirstZodSchema = z.object({ select: DocumentationFindFirstSelectSchema.optional(),  orderBy: z.union([DocumentationOrderByWithRelationInputObjectSchema, DocumentationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DocumentationWhereInputObjectSchema.optional(), cursor: DocumentationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DocumentationScalarFieldEnumSchema, DocumentationScalarFieldEnumSchema.array()]).optional() }).strict();