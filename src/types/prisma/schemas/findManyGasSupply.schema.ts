...
export const GasSupplyFindManySelectSchema: z.ZodType<Prisma.GasSupplySelect> = z.object({
...
export const GasSupplyFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    kmToReview: z.boolean().optional(),
    kmToStop: z.boolean().optional(),
    quantity: z.boolean().optional(),
