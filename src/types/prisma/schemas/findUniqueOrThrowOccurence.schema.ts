...
export const OccurenceFindUniqueOrThrowSchema: z.ZodType<Prisma.OccurenceFindUniqueOrThrowArgs> = z.object({ select: OccurenceSelectObjectSchema.optional(), include: OccurenceIncludeObjectSchema.optional(), where: OccurenceWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.OccurenceFindUniqueOrThrowArgs>;

export const OccurenceFindUniqueOrThrowZodSchema = z.object({ select: OccurenceSelectObjectSchema.optional(), include: OccurenceIncludeObjectSchema.optional(), where: OccurenceWhereUniqueInputObjectSchema }).strict();