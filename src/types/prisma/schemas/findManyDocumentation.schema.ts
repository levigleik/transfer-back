...
export const DocumentationFindManySelectSchema: z.ZodType<Prisma.DocumentationSelect> = z.object({
...
export const DocumentationFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    expiryAt: z.boolean().optional(),
    antecipateRenewal: z.boolean().optional(),
...
export const DocumentationFindManySchema: z.ZodType<Prisma.DocumentationFindManyArgs> = z.object({ select: DocumentationFindManySelectSchema.optional(),  orderBy: z.union([DocumentationOrderByWithRelationInputObjectSchema, DocumentationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DocumentationWhereInputObjectSchema.optional(), cursor: DocumentationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DocumentationScalarFieldEnumSchema, DocumentationScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.DocumentationFindManyArgs>;

export const DocumentationFindManyZodSchema = z.object({ select: DocumentationFindManySelectSchema.optional(),  orderBy: z.union([DocumentationOrderByWithRelationInputObjectSchema, DocumentationOrderByWithRelationInputObjectSchema.array()]).optional(), where: DocumentationWhereInputObjectSchema.optional(), cursor: DocumentationWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([DocumentationScalarFieldEnumSchema, DocumentationScalarFieldEnumSchema.array()]).optional() }).strict();